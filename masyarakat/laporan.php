            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-2 text-warning font-weight-bold">Form Tambah Laporan</h1>
                    </div>
                        ...
                        <div class="col-xl-12 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-warning">Silahkan masukan data</h6>
                                </div>
                                ...
                                <div class="card-body">
                                    <form method="POST" enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <textarea name="message" class="form-control" placeholder="Silahkan masukan deskripsi laporan"></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label class="lable-control" for="password">Photo</label>
